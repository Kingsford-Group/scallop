...
lines(data1[,16], data1[,13], col = 2, lty = 3, lwd = 2);
lines(data2[,16], data2[,13], col = 3, lty = 3, lwd = 2);
lines(data3[,16], data3[,13], col = 4, lty = 3, lwd = 2);
lines(data4[,16], data4[,13], col = 2, lty = 5, lwd = 2);
lines(data5[,16], data5[,13], col = 3, lty = 5, lwd = 2);
lines(data6[,16], data6[,13], col = 4, lty = 5, lwd = 2);


points(dataA[,16], dataA[,13], col = 2, pch = 2, lwd = 2);
points(dataB[,16], dataB[,13], col = 3, pch = 2, lwd = 2);
points(dataC[,16], dataC[,13], col = 4, pch = 2, lwd = 2);
points(dataD[,16], dataD[,13], col = 2, pch = 1, lwd = 2);
points(dataE[,16], dataE[,13], col = 3, pch = 1, lwd = 2);
points(dataF[,16], dataF[,13], col = 4, pch = 1, lwd = 2);

legend(xmin + (xmax - xmin) * 0.7, ymax, c("STAR", "TopHat"), lwd = c(2, 2), pch = c(1, 2), lty = c(5, 3));
legend(xmin, ymin + (ymax - ymin) * 0.2, c("Scallop", "StringTie", "TransComb"), lwd = c(2, 2), col = c(2,3,4), lty = c(1, 1, 1));
