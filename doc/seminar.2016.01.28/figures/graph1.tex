...
\path<4-> node at (2 * \len, -0.36cm) {$5$};
\path<4-> node at (3 * \len, -0.36cm) {$1$};
\path<4-> node at (4 * \len, -0.36cm) {$5$};
\path<4-> node at (5 * \len, -0.36cm) {$5$};
\path<4-> node at (6 * \len, -0.36cm) {$5$};
\path<4-> node at (7 * \len, -0.36cm) {$3$};
\path<4-> node at (8 * \len, -0.36cm) {$2$};

\path<4-> node at (1.5 * \len, 0.2cm) {$5$};
\path<4-> node at (2.5 * \len, 0.2cm) {$1$};
\path<4-> node at (3.5 * \len, 0.2cm) {$1$};
\path<4-> node at (4.5 * \len, 0.2cm) {$5$};
\path<4-> node at (5.5 * \len, 0.2cm) {$5$};
\path<4-> node at (6.5 * \len, 0.2cm) {$3$};
\path<4-> node at (8.5 * \len, 0.2cm) {$2$};


\path<4-> node at (3.0 * \len, 0.9cm) {$4$};
\path<4-> node at (7.0 * \len, 0.9cm) {$2$};
\path<4-> node at (8.0 * \len, 0.9cm) {$3$};

\end{scope}
%\path<4-> [draw, rounded corners] ($(bbox.south west) - (0.00cm, 0.25cm)$) rectangle ($(bbox.north east) + (0.1cm, 0)$);
