...
\path<1-> [draw, \cola, ->, line width=0.10cm] (v2) -- (v3);
...
\path<1-> node at (1.5 * \len, 0.2cm) {$3$};
\path<1-> node at (2.5 * \len, 0.2cm) {$3$};
\path<1-> node at (3.5 * \len, 0.2cm) {$5$};
\path<1-> node at (4.5 * \len, 0.2cm) {$3$};
\path<1-> node at (5.5 * \len, 0.2cm) {$3$};

\path<1-> node at (2.0 * \len, 1.0cm) {$2$};
\path<1-> node at (5.0 * \len, 1.0cm) {$2$};
